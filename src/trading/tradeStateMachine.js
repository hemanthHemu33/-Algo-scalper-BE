...
const ALLOWED_TRANSITIONS = {
  ...
  [STATUS.LIVE]: new Set([STATUS.EXIT_PLACED, STATUS.EXIT_OPEN, STATUS.EXIT_PARTIAL, STATUS.EXIT_FILLED, STATUS.PANIC_EXIT_PLACED, STATUS.PANIC_EXIT_CONFIRMED, STATUS.EXITED_TARGET, STATUS.EXITED_SL, STATUS.GUARD_FAILED, STATUS.CLOSED]),
  [STATUS.SL_PLACED]: new Set([STATUS.SL_OPEN, STATUS.SL_CONFIRMED, STATUS.PANIC_EXIT_PLACED, STATUS.GUARD_FAILED, STATUS.CLOSED]),
  [STATUS.SL_OPEN]: new Set([STATUS.SL_CONFIRMED, STATUS.PANIC_EXIT_PLACED, STATUS.GUARD_FAILED, STATUS.CLOSED]),
  [STATUS.SL_CONFIRMED]: new Set([STATUS.LIVE, STATUS.EXIT_PLACED, STATUS.EXIT_OPEN, STATUS.PANIC_EXIT_PLACED, STATUS.CLOSED]),
