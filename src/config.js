...
const schema = z.object({
  ...
  VWAP_ENABLED: boolFromEnv.default(true),
  SWING_LOOKBACK: z.coerce.number().default(20),
  LEVELS_CACHE_TTL_SEC: z.coerce.number().default(30),
  LIQUIDITY_BUFFER_MODE: z.string().default("ATR"),
  LIQUIDITY_BUFFER_ATR_MULT: z.coerce.number().default(0.1),
  LIQUIDITY_BUFFER_MIN_TICKS: z.coerce.number().default(4),
  LIQUIDITY_BUFFER_MAX_TICKS: z.coerce.number().default(20),
  LIQ_BUFFER_ATR_PCT: z.coerce.number().default(0.10),
  LIQ_BUFFER_MIN_TICKS: z.coerce.number().default(4),
  LIQ_BUFFER_MAX_TICKS: z.coerce.number().default(30),
  ROUND_NUMBER_GUARD_ENABLED: boolFromEnv.default(true),
  ROUND_NUMBER_STEP: z.coerce.number().default(50),
  ROUND_NUMBER_BUFFER_TICKS: z.coerce.number().default(4),
  AVOID_ROUND_LEVELS: boolFromEnv.default(true),
  ROUND_LEVEL_STEP: z.coerce.number().default(50),
  VOL_SCALER_ENABLED: boolFromEnv.default(true),
  VOL_ATR_SOURCE: z.string().default("UNDERLYING"),
  VOL_ATR_LEN: z.coerce.number().default(14),
  VOL_ATR_TARGET_PTS: z.coerce.number().default(18),
  VOL_TARGET_BPS: z.coerce.number().default(65),
  VOL_SCALER_MIN: z.coerce.number().default(0.8),
  VOL_SCALER_MAX: z.coerce.number().default(1.3),
  VOL_SCALE_MIN_GREEN_R: boolFromEnv.default(true),
  VOL_SCALE_BE_ARM_R: boolFromEnv.default(true),
  VOL_SCALE_TRAIL_ARM_R: boolFromEnv.default(true),
  STRATEGY_STOP_ANCHOR_MAP: z
    .string()
    .default(
      "breakout:ORB,ema_pullback:SWING,vwap_reclaim:VWAP,fakeout:DAY_LEVEL",
    ),
  STOP_ANCHOR_MAP: z
    .string()
    .default(
      "breakout:ORB,breakdown:ORB,ema_pullback:SWING,ema_cross:SWING,vwap_reclaim:VWAP,fakeout:DAY_LEVEL,wick_reversal:DAY_LEVEL",
    ),
  STRUCTURE_ACTIVATE_AT_R: z.coerce.number().default(0.6),
  STRUCTURE_MAX_TIGHTEN_R: z.coerce.number().default(2.5),
  TRAIL_MODEL: z.string().default("ATR"),
  TRAIL_ATR_SOURCE: z.string().default("PREMIUM"),
  TRAIL_ATR_LEN: z.coerce.number().default(14),
  TRAIL_ATR_K_RANGE: z.coerce.number().default(1.0),
  TRAIL_ATR_K_TREND: z.coerce.number().default(1.4),
  TRAIL_ATR_K_OPEN: z.coerce.number().default(1.6),
  ...
  PROFIT_LOCK_ENABLED: z.string().default("true"),
  PROFIT_LOCK_R: z.coerce.number().default(1.0),
  PROFIT_LOCK_KEEP_R: z.coerce.number().default(0.25),
  PROFIT_LOCK_LADDER: z.string().default("1.0:0.20,1.5:0.60,2.0:1.00"),
  PROFIT_LOCK_MIN_INR: z.coerce.number().default(0),
  PROFIT_LOCK_COST_MULT: z.coerce.number().default(1.0),
  ...
  ENTRY_MAX_SPREAD_BPS_OPT_PASSIVE: z.coerce.number().default(25),
  ENTRY_MAX_SPREAD_BPS_OPT_AGGR: z.coerce.number().default(60),
  ENTRY_MIN_PREMIUM: z.coerce.number().default(30),
  ...
  EXECUTION_BREAKER_ENABLED: boolFromEnv.default(true),
  EXEC_BREAKER_AVG_SLIP_PTS_MAX: z.coerce.number().default(2.0),
  EXEC_BREAKER_WINDOW_TRADES: z.coerce.number().default(5),
  EXEC_BREAKER_COOLDOWN_SEC: z.coerce.number().default(900),
