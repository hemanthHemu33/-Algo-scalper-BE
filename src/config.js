...
const schema = z.object({
  ...
  STRUCTURE_SOURCE: z.string().default("TRADE"),
  STRUCTURE_CANDLE_LIMIT: z.coerce.number().default(800),
  ORB_ENABLED: boolFromEnv.default(true),
  ORB_MINUTES: z.coerce.number().default(15),
  ORB_CONFIRM_MODE: z.string().default("CLOSE"),
  ORB_CONFIRM_BARS: z.coerce.number().default(1),
  VWAP_ENABLED: boolFromEnv.default(true),
  VWAP_CONFIRM_MODE: z.string().default("CLOSE"),
  VWAP_CONFIRM_BARS: z.coerce.number().default(1),
  DAY_LEVELS_ENABLED: boolFromEnv.default(true),
  PREV_DAY_LEVELS_ENABLED: boolFromEnv.default(false),
  WEEK_LEVELS_ENABLED: boolFromEnv.default(false),
  ANCHOR_BUFFER_TICKS: z.coerce.number().default(2),
  ANCHOR_MIN_GAP_ATR_MULT: z.coerce.number().default(0.3),
  ANCHOR_MIN_GAP_TICKS: z.coerce.number().default(10),
  ANCHOR_MAX_TIGHTEN_PER_EVAL_PTS: z.coerce.number().default(999999),
  ANCHOR_APPLY_AFTER_MIN_GREEN: boolFromEnv.default(true),
  ANCHOR_APPLY_AFTER_BE_ARM: boolFromEnv.default(true),
  ANCHOR_APPLY_AFTER_PROFIT_LOCK_STEP: boolFromEnv.default(true),
  ANCHOR_PRIORITY: z.string().default("VWAP,ORB,DAY,PREV_DAY,WEEK"),
