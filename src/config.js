...
const schema = z.object({
  ...
  STRUCTURE_ANCHORS_ENABLED: z.string().default("DAY,PREVDAY,WEEK,ORB,VWAP,SWING"),
  ...
  STOP_ANCHOR_MAP: z
    .string()
    .default(
      "breakout:ORB_HIGH,breakdown:ORB_LOW,ema_pullback:SWING,ema_cross:SWING,vwap_reclaim:VWAP,fakeout:DAY_LEVEL,wick_reversal:DAY_LEVEL",
    ),
